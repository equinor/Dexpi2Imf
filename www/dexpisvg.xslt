    ...
    <xsl:template match="*">
        ...
        <xsl:variable name="labelA">
            <xsl:choose>
                <xsl:when test="$componentName = 'IM005B_SHAPE'">
                    <xsl:value-of
                            select="concat(../../../../PlantStructureItem/GenericAttributes/GenericAttribute[@Name='ProcessPlantIdentificationCodeAssignmentClass']/@Value, '-', ../../../../PlantStructureItem/GenericAttributes/GenericAttribute[@Name='PlantSystemIdentificationCodeAssignmentClass']/@Value)"/>
                </xsl:when>
                <xsl:otherwise/>
            </xsl:choose>
        </xsl:variable>
        <xsl:variable name="labelB">
            <xsl:choose>
                <xsl:when test="$componentName = 'IM005B_SHAPE'">
                    <xsl:value-of
                            select="../GenericAttributes/GenericAttribute[@Name='TagTypeAssignmentClass']/@Value"/>
                </xsl:when>
                <xsl:otherwise/>
            </xsl:choose>
        </xsl:variable>
        <xsl:variable name="labelC">
            <xsl:choose>
                <xsl:when test="$componentName = 'IM005B_SHAPE'">
                    <xsl:value-of
                            select="concat(../GenericAttributes/GenericAttribute[@Name='SequenceAssignmentClass']/@Value, ../GenericAttributes/GenericAttribute[@Name='TagSuffixAssignmentClass']/@Value)"/>
                </xsl:when>
                <xsl:otherwise/>
            </xsl:choose>
        </xsl:variable>
        <xsl:variable name="labelD">
            <xsl:choose>
                <xsl:when test="$componentName = 'IM005B_SHAPE'">
                    <xsl:value-of
                            select="../GenericAttributes/GenericAttribute[@Name='TypicalReferenceAssignmentClass']/@Value"/>
                </xsl:when>
                <xsl:otherwise/>
            </xsl:choose>
        </xsl:variable>
